...
public class AudioSyncScale : AudioSyncer
{
    ...
    // when a beat occurs, we move to beatscale
    // when a rest occurs, we move to restscale
    ...
    // scale currently maniuplated by beat
    // if not in beat state, lerp scale to rest scale
    public override void OnUpdate()
    {
        ...
        transform.localScale = Vector3.Lerp(transform.localScale, restScale, 
